@extends('layouts.app')
@section('title', 'Pengurus Periode 2022–2025')
@section('meta_description', 'Susunan pengurus PERHUMASRI Wilayah Sulawesi Selatan Periode 2022–2025.')
...
<div class="pt-36 pb-16 bg-surface-warm min-h-screen">
    <div class="container-site">
        <div class="flex items-center gap-2 text-sm text-gray-500 mb-6">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
            <span class="text-gray-900 font-medium">Periode 2022–2025</span>
        </div>

        @if($periode && $periode->penguruses->isNotEmpty())
        ...
        @else
            <div class="text-center py-24 text-gray-400">
                <h1 class="text-2xl font-bold text-gray-700 mb-3">Periode 2022–2025</h1>
                <p class="text-base text-gray-500">Data pengurus periode ini belum dimasukkan.</p>
                <p class="text-sm text-gray-400 mt-1">Admin dapat menambahkan melalui panel manajemen.</p>
            </div>
        @endif
    </div>
</div>
